...
- No remaining enablement-wave blockers. `033`, `035`, and `038` are complete; `014` is the only
  ticket left on the analytics-to-profile spine, unblocked and ready for backend work. `036`
  (popularity regression) was **cut entirely** — [ADR-0016](../decisions/adr/0016-cut-second-regression-model.md):
